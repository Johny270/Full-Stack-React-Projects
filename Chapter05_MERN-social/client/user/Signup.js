...
export default function Signup() {
    // Initializing the state with empty input field values
    // an empty error message and set the dialogue open variable
    // to false
    ...
    // set the state with the new value that's entered in the 
    // input field. It is to be called when the input values change
