...
export default function Course ({match}) {
    ...
    // Retrieve the course image as a file response
    ...
    return (
        <div>
            ...
            {/* conditionally render the edit button if the 
                current user is signed in and their ID matches the 
                course instructor's ID
            */}
            ...
            { auth.isAuthenticated().user && auth.isAuthenticated().userId == course.instructor._id &&
                !course.published &&
